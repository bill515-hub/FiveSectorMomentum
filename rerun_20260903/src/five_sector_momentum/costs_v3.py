...
def build_fee_rules(
    ...
    # Tushare expresses this field in thousandths (千分数), not ten-thousandths.
    data["fee_rate"] = data["trading_fee_rate"].fillna(0.0) / 1000.0
...
def _rule_row(
    ...
    return {
        ...
        "fee_rate_unit": "成交金额比例（Tushare原值/1000）",
